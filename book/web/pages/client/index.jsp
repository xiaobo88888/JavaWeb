	...
	<script type="text/javascript">
		$(function (){
			...
			$("button.addToCart").click(function(){
				/**
				 * 在事件响应的function函数中，有一个this对象，这个this对象是当前正在响应的dom对象
				 * 然后获取返回元素的属性值，这里通过button元素获取了bookId属性值
				 * @type {*|jQuery}
				 */
...
<body>
	...
	<div id="header">
			...
			<div>
				<%--如果用户信息没有保存，说明没有登录，那么只显示登录和注册就行了--%>
		...
		<div id="book">
			...
			<div style="text-align: center">
				<c:if test="${empty sessionScope.cart.items}">
					...
					<div>
						<span style="color: red" id="cartLastName" >您的购物车中没有商品</span>
					</div>
				</c:if>
